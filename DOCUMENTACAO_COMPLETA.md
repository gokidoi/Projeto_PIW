# 📋 Excelência Fitness - Sistema de Inventário e Marketplace

## 🎯 Visão Geral

Sistema web completo de inventário de suplementos e marketplace para academias, desenvolvido em React.js com Firebase como backend. O sistema permite gerenciar estoque, calcular lucros, gerar relatórios, monitorar vencimentos e operar como marketplace onde fornecedores podem publicar produtos.
